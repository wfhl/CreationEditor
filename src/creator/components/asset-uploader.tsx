            ...
            {viewMode === 'upload' ? (
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2 md:gap-3">
                        ...
                        {assets.length === 0 && (
                            ...
                            >
                                ...
                                <span className="text-[10px] font-bold text-white/20 uppercase tracking-widest">No images selected</span>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between px-1">
                        <div className="text-[10px] text-white/40 uppercase tracking-widest font-bold">Reference Library</div>
                        <button
                        ...
                        <input type="file" ref={userLibInputRef} className="hidden" accept="image/*" multiple onChange={handleUserLibUpload} />
                    </div>
                        ...
                        <div className="w-full grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2 mb-6 p-1">
                            {userLibraryAssets.map((asset) => {
                                ...
                                return (
                                    ...
                                    >
                                        <img src={asset.base64} alt={asset.name} loading="lazy" className={`w-full h-full object-cover transition-opacity ${isSelected ? 'opacity-100' : 'opacity-80 group-hover:opacity-100'}`} />
                                        {isSelected && (
