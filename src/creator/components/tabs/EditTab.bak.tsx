        ...
        <div className="max-w-[1200px] mx-auto w-full p-4 md:p-8 pb-32">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                    <div className="p-4 md:p-8 border-b md:border-b-0 md:border-r border-white/5">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                        <button
                                            ...
                                            disabled={!refinePrompt || (selectedModel.toLowerCase().match(/grok|seedream|wan|fal/i) ? !apiKeys.fal : !apiKeys.gemini)}
